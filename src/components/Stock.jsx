     ...
     return (
       <div>
        <div className='bg-emerald-700 rounded-2xl text-white text-4xl font-semibold py-2 font-serif flex justify-center'>
            <h1 className=''>Indian Stocks</h1>   
        </div>
         
         <div className="custom-scrollbar scroll-hidden hide px-4 relative p-6 flex flex-row flex-nowrap overflow-x-auto space-x-12 mb-7">
           {hasContent ? (
             articles.map((item, index) => (
               ...
               >
                 <div className="w-[200px] h-[285px] p-4 bg-white rounded-2xl shadow-xl transform hover:scale-102 transition-transform duration-300 ease-in-out flex flex-col hover:bg-yellow-100">
                   <img
