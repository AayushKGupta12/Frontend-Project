...
export default function LiveUser() {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('http://127.0.0.1:5000/liveUser');
  ...
  return (
    <div className="flex gap-2 justify-center items-center px-3 bg-emerald-100 border border-emerald-800 w-32 h-10 mx-2
     rounded shadow-2xs text-center font-sans">
