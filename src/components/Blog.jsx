...
function Blog() {
  ...
  return (
    <div>
      ...
      <div className="custom-scrollbar px-4 relative p-6 flex flex-row flex-nowrap overflow-x-auto space-x-12 mb-7">
        {hasContent ? (
          articles.map((item, index) => (
            ...
            >
              <div className="w-[200px] h-[285px] p-4 bg-white rounded-2xl shadow-2xl transform hover:scale-102 transition-transform duration-300 ease-in-out flex flex-col hover:bg-yellow-100">
                <img
                  className="w-full h-[140px] object-cover rounded-xl"
                  alt={item.title || "Card Image"}
                  src={item.image_url || "https://via.placeholder.com/260x140"}
                />
